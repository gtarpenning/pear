...
class MessageHandler:
    ...
    def add_message(self, username: str, content: str, message_type: str = "text") -> ChatMessage:
    ...
    def get_message_stats(self) -> dict:
        ...
        users = set(msg.username for msg in self.messages if msg.message_type != "system")
